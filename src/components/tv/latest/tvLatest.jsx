                                            ...
                                            <>
                                                <div key={i} className={`${styles.tab_content_area} ${tab === i ? `${styles.active}` : "" } d-flex justify-content-between`}>
                                                    ...
                                                    <div className={styles.content_area}>
                                                        ...
                                                        <Link href={`/tv/${item.id}`} className={`${styles.global_button} global_button`}>
