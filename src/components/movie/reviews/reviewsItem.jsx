        ...
        <>
            <div className={`${styles.author_details}`}>
                <div className={`${styles.author_head} d-flex align-items-center`}>
                    <Image 
                        loading="lazy"
                        src={`${item.author_details.avatar_path !==null && item.author_details.avatar_path !== 'null' ? `${enviourment.image_base_url}/w300/${item.author_details.avatar_path}`:"/images/placeholder.svg"}`}
                        fill={true} 
                        alt="" 
                    />
                    <div>
