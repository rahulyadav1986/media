                ...
                <div className={styles.person_list_details_wrap}>
                    ...
                    <div className={styles.person_main_details_wrapper}>
                        ...
                        <h4>Known For Tv Shows</h4>
                        {
                            ...
                            :
                            <div className='no-data'>No tv data available right now for this person</div>
                        }
...
export async function getServerSideProps(context){
    ...
    const responssCastDetails = await fetch(`${env.apiUrl}/person/${params.personId}/tv_credits?api_key=${env.tmdbApiKey}`);
