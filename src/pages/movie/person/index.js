                                                ...
                                                <div key={i} className={styles.portion}>
                                                    <div className="card_wrapper">
                                                        <div className={`${styles.image_wrapper} image_wrapper`}>
                                                            <Link href={`/movie/person/${item.id}`}><Image src={`${env.image_base_url}/w300${item.profile_path}`} fill={true} alt={item.name} /></Link>                                                    
                                                        </div>
                                                        <h3><Link href={`/movie/person/${item.id}`}>{item.name}</Link></h3>
                                                    </div>
                                                </div>
                                            }
