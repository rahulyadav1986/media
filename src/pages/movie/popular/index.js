...
const Popular = ()=>{
    ...
    const url = `${env.apiUrl}/movie/popular?api_key=${env.tmdbApiKey}&page=${pageCount}`;
    const NextPage = ()=>{
    ...
    const getData = async(pageCount)=>{
        setTimeout(() => setLoading(true), 2000);
        const PopularDataResponse = await fetch(`${env.apiUrl}/movie/popular?api_key=${env.tmdbApiKey}&page=${pageCount}`)
